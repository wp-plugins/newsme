...
**[Read the case study now](http://newsatme.com/publisher-can-build-new-source-traffic-active-user-base-11-months/?utm_source=Wordpress&utm_medium=plugin%20page&utm_content=GalileoCase&utm_campaign=Wordpress%20Plugin%20Page)**
...
**Email signup form.** Give your readers the opportunity to subscribe to your articles and topics. A simple signup form with a minimalistic design at the end of each article. Create a unique bond between your readers and your editorial activity based on something valuable: their interests, passions and curiosities.
...
**Accurate audience segmentation.** We introduce a new criteria for segmenting your online audience: interests and passions. Grow your audience and build high-quality mailing lists based on the topics your readers are interested in the most.
...
**Automated targeted newsletter.** Create a unique experience for your readers. Subscribers receive updates on articles and topics of interest through an elegant email digest. Invite your readers to return to your site and read new articles about their interests, put their passions at the center of your conversation.

**News manager for your readers.** Let your subscribers choose which articles to get in the email newsletter digest, day by day and if their passions and interests change..your newsletter digest changes too! The News manager is a simple and intuitive service offered for free to your subscribers.

**Editorial activity analysis.** Take a careful look at the traffic and the number of subscribers who return to your site. Plan ahead your online editorial activity with the certainty of knowing in advance the degree of involvement and interest of your readers, topic by topic.
...
* FIX: issue with slashes not being escaped when saving topics

= 3.2.3 = 

* FIX: new asset names to avoid caches 

= 3.2.2 =

* FIX: amend unclosed div in metabox
...
* CHANGE: Hide widget on post option in metabox
* CHANGE: Add topics now mimics Add tags metabox
* CHANGE: Topics now case sensitive

= 3.1.1 = 

* CHANGE: Add plugin translation for Italian language 
* CHANGE: Replace Activation label with Account
* CHANGE: New URL for creating API key
* CHANGE: Add mini global navigation in Italian and English language 

= 3.1.0 = 

* CHANGE: New settings page to select cutom post types 
* CHANGE: News@me menu moved to top level 

= 3.0.1 =

* FIX: HTML entities are now escaped in meta box tags
...
* CHANGE: News@me tags metabox becomes News@me topics metabox
