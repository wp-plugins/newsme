...
* CHANGE: add siteurl header to API calls to allow multi domain sites
...
* CHANGE: Add intro to Preferences page
* CHANGE: Add success notification message in metabox
